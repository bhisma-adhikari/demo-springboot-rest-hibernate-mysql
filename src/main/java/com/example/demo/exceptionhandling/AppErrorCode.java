...
public enum AppErrorCode {
    ...
    PUT_USERS__ID_MISMATCHING("3.400.3", "VALIDATION ERROR: user id from request URL must match the user id in request body"),
    PUT_USERS__FIRSTNAME_MISSING("3.400.4", "VALIDATION ERROR: firstName missing"),
    PUT_USERS__FIRSTNAME_INVALID("3.400.5", "VALIDATION ERROR: firstName invalid"),
    PUT_USERS__LASTNAME_MISSING("3.400.6", "VALIDATION ERROR: lastName missing"),
    PUT_USERS__LASTNAME_INVALID("3.400.7", "VALIDATION ERROR: lastName invalid"),
    PUT_USERS__LOGIN_CREDENTIAL_MISSING("3.400.8", "VALIDATION ERROR: loginCredential missing"),
    PUT_USERS__LOGIN_CREDENTIAL_ID_MISSING("3.400.9", "VALIDATION ERROR: loginCredential.id missing"),
    PUT_USERS__LOGIN_CREDENTIAL_ID_NONEXISTING("3.400.10", "VALIDATION ERROR: loginCredential.id non-existing; loginCredential with id {} does not exist"),
    PUT_USERS__LOGIN_CREDENTIAL_USERNAME_MISSING("3.400.11", "VALIDATION ERROR: loginCredential.username missing"),
    PUT_USERS__LOGIN_CREDENTIAL_USERNAME_INVALID("3.400.12", "VALIDATION ERROR: loginCredential.username invalid"),
    PUT_USERS__LOGIN_CREDENTIAL_USERNAME_EXISTING("3.400.13", "VALIDATION ERROR: loginCredential.username existing; This username is not available"),
    ...
    PUT_NOTES__ID_NONEXISTING("6.400.3", "VALIDATION ERROR: note with id {} does not exist"),
    PUT_NOTES__ID_MISMATCHING("6.400.4", "VALIDATION ERROR: note id from request URL must match the note id in request body"),
    PUT_NOTES__ID_NOT_FOUND("6.400.5", "VALIDATION ERROR: note not found for given id"),
    PUT_NOTES__TEXT_INVALID("6.400.6", "VALIDATION ERROR: missing or text invalid"),
    PUT_NOTES__GENRES_MISSING("6.400.7", "VALIDATION ERROR: genres missing"),
    PUT_NOTES__GENRES_EMPTY("6.400.8", "VALIDATION ERROR: genres invalid; cannot be empty"),
    PUT_NOTES__USER_ID_MISSING("6.400.9", "VALIDATION ERROR: userId missing"),
    PUT_NOTES__USER_ID_NONEXISTING("6.400.10", "VALIDATION ERROR: userId non-existing; user with id {} does not exist"),
